...
const SettingsPage = () => {
  ...
  useEffect(() => {
    if (currentUser) {
      setDisplayName(currentUser.displayName || userData?.displayName || userData?.firstName || '');
      setEmail(currentUser.email || '');
    }
    if (userData) {
      setNotifications(userData.notificationsEnabled !== false);
      setProfileVisible(userData.profileVisible !== false);
      setAutoAcceptConnections(userData.autoAcceptConnections === true);
    }
  ...
  return (
    <DashboardShell heading="Settings" subheading="Manage your account preferences">
            ...
            <div className="flex items-center justify-between">
              <div className="space-y-0.5">
                ...
                <p className="text-sm text-muted-foreground">
                  Show or hide your profile from recruiters
                </p>
              </div>
              <Switch
                id="profileVisible"
              ...
              <AlertDialogContent>
                <AlertDialogHeader>
                  ...
                  <AlertDialogDescription>
                    ...
                    and remove all your data from our servers. All your connections, messages,
                    applications, and profile information will be deleted.
                  </AlertDialogDescription>
                </AlertDialogHeader>
                <AlertDialogFooter>
