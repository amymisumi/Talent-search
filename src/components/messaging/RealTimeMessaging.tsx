        ...
        if (userIds.length > 0) {
          const unsubscribePresence = subscribeToMultipleUsersPresence(userIds, (presence) => {
            ...
            setConnections(prev => prev.map(conn => {
              ...
              // Only set online if presence explicitly says online
            ...
            {sortedConnections.length === 0 ? (
              ...
              <div className="space-y-1 p-2">
                {sortedConnections.map((connection) => {
                  ...
                  // Only show online if presence explicitly says online
                  ...
                  <p className="text-xs text-muted-foreground">
                    {(() => {
                      ...
                      : selectedConnection.lastSeen 
                        ? `Last seen ${getLastSeenText(selectedConnection.lastSeen)}`
                        : 'Offline'}
                    {' • '}
